...
const action: (file: string, options: Options) => Promise<void> = withCommandHandling(
  "command:import",
...
function renderImportTextResults(results: ImportResultItem[], dryRun: boolean): void {
