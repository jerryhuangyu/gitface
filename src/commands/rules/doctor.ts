...
async function buildDoctorReport(concurrency: number): Promise<RuleDoctorReport> {
...
const doctorRuleAction: (options: RuleDoctorOptions) => Promise<void> = withCommandHandling(
  "command:rules:doctor",
  async (options) => {
