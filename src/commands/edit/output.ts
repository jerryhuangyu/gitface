...
export const sendProfileUpdateSuccessMsg: (profileName: string) => void = (profileName) => {
  console.log(`\n${chalk.green("✔")} Updated profile '${profileName}'.`);
};

export const sendProfileUpdateDryRunMsg: (profileName: string) => void = (profileName) => {
...
export const sendProfileUpdateFailedJson = (name: string, reason: string): void => {
  console.log(
    JSON.stringify({
      status: "error",
      name,
